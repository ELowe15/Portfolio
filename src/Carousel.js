        ...
        {media.length > 1 && (
          <>
            <button
              ...
              } top-1/2 transform -translate-y-1/2 bg-lightButton hover:bg-lightButtonHover text-black p-1.5 rounded-full dark:bg-darkTool dark:hover:bg-hoverDarkTool dark:text-white z-50`}
            >
              &lt;
            </button>
            <button
